...
```
BUILD_ORDER=zsq SEARCH_ORDER=zsq THREAD_COUNT=32 LINK_RANGE=64 LINK_CANDIDATE_SIZE=600 BUILD_ITER_COUNT=5 SEARCH_RANGES=10,15,20,30,40,50,75,100,150,200,300,400,800 TOP_KS=10 WARMUP_QUERIES=1000 ROUNDS=5 bash zsq_arm64_bundle/run_on_b.sh falcon/dataset zsq_top10_l64_c600_i5
```
